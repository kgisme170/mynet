...
void protobuf_AssignDesc_embed_2eproto() GOOGLE_ATTRIBUTE_COLD;
void protobuf_AssignDesc_embed_2eproto() {
  protobuf_AddDesc_embed_2eproto();
...
inline void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_embed_2eproto);
}
...
void protobuf_ShutdownFile_embed_2eproto() {
...
void protobuf_AddDesc_embed_2eproto() GOOGLE_ATTRIBUTE_COLD;
void protobuf_AddDesc_embed_2eproto() {
  ...
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_embed_2eproto);
}

// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_embed_2eproto {
  StaticDescriptorInitializer_embed_2eproto() {
    protobuf_AddDesc_embed_2eproto();
  }
} static_descriptor_initializer_embed_2eproto_;
...
const Person_PhoneNumber& Person_PhoneNumber::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_embed_2eproto();
